...
oldSession.get = Session.get;
oldSession.set = Session.set;
oldSession.clear = Session.clear;
oldSession.setDefault = Session.setDefault;
oldSession._ensureKey = Session._ensureKey
